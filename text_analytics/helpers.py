# FIX 1: The gensim.parsing.preprocessing module is removed in modern Gensim.
# We will use string methods and cleantext for these operations instead.
...
def remove_punctuation(line):
    ...
    :return:
    """
    # FIX 1 (continued): Replace the deprecated gensim.parsing.preprocessing functions
    line = cleantext.clean(line, no_punct=True, no_digits=True, no_currency_symbols=True)
...
def nlp_tag(text, nlp=None):
    ...
    if not nlp:
        nlp = spacy.load("en_core_web_sm")
    # FIX 2: Use settings.SPACY_MAX_LENGTH instead of an undefined variable
