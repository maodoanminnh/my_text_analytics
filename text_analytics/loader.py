...
class ExternalFileLoader(object):
    ...
    def __init__(self, **kwargs):
        ...
        # FIX 1: Use settings.DATA_DIR and settings.STATES_DIR instead of undefined variables
    ...
    def _load_state(self, filename, file_type=None, state_type=None):
        ...
        with open(path, "rb") as fo:
            data = fo.read()
        # FIX 2: Corrected typo from deserealize to deserialize
        return SERIALIZERS[state_type](data).deserialize()
